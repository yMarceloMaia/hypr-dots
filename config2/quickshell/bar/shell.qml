...
ShellRoot {
    ...
    // Uma barra por monitor: Variants itera sobre todas as telas e passa `screen`.
    // O Loader escolhe o estilo da barra conforme theme.barStyle ("default" | "minimal").
    Variants {
        ...
        Loader {
            ...
            active: true
            sourceComponent: theme.barStyle === "minimal" ? compMinimalBar : compDefaultBar

            Component {
                id: compDefaultBar
                BarSlot { root: theme; screen: barLoader.modelData }
            }
            Component {
                id: compMinimalBar
                BarMinimal { root: theme; screen: barLoader.modelData }
            }
        }
    }
